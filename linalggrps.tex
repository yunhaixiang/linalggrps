...
\begin{example}
    ...
    \end{enumerate}
\end{example}
\begin{remark}The choice of $\omega$ for a quadratic étale $R$-algebra $E$ is not necessarily unique, but one can show that all groups in \Cref{ex:unitary} does not depend on the choice of $\omega$. 
\end{remark}
