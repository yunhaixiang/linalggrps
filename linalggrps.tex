...
\begin{definition}
    ...
    \end{enumerate}
\end{definition}
\begin{remark}The assumption of finite projectiveness in \Cref{def:base} is to ensure the base changed or restricted group functors are indeed algebraic groups. 
\end{remark}
\begin{example}
\end{example}
