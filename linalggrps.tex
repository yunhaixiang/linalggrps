...
\begin{remark}Another important family of algebraic groups is the \textit{exceptional groups}: $\mathrm G_2, \mathrm F_4, \mathrm E_6, \mathrm E_7$, and $\mathrm E_8$, which we will not define until later. Some other commonly seen algebraic groups which we will not talk about in detail are: $\mathrm{Pin}, \mathrm{Spin}, \mathrm{GPin}$, and $\mathrm{GSpin}$.
\end{remark}
