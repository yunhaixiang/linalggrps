...
\section{Definition and Examples of Algebraic Groups}
...
\end{example}
\begin{remark}Some other important algebraic groups include a family of algebraic groups called \textit{exceptional groups}: $\mathrm G_2, \mathrm F_4, \mathrm E_6, \mathrm E_7$, and $\mathrm E_8$, which we will not define until later. 
\end{remark}

\newpage 


\section{Basic Properties of Algebraic Groups}
